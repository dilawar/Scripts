...
async13_url=svn+ssh://dilawars@svn.code.sf.net/p/moose/code/moose/branches/async13
...
if [[ $1 = "git" ]]; then
    ...
    echo "git svn clone $async13_url"
    git svn clone $async13_url moose_async_git_svn
else
